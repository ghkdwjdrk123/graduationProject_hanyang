...
if __name__ == '__main__':
    ...
    for i in range(0, 20):
        ...
        #  논문의 코드에서의 elitism은 일종의 mutation이다. crossovers는 없음. 그래서 추가해보았다.
                
        crossovers = [
                new_parents[0][:3] + new_parents[1][3:],
                new_parents[1][:3] + new_parents[0][3:],
                new_parents[2][:3] + new_parents[3][3:],
                new_parents[3][:3] + new_parents[2][3:]
        ]

        current_solution_pool = elites + crossovers
